...
$(() => {
  ...
  Fancybox.bind("[data-fancybox]:not([data-src='#currencies-popup']):not(.checkboxes-groups-popup-trigger):not([data-src='#cities-popup']):not([data-src='#additional-filters-popup'])", {
    dragToClose: false
  });
